...
class TestLogoNavigation:
    ...
    def test_logo_redirects(self, main_page, locator, expected_elements, opens_new_tab):
        main_page.accept_cookies_if_present()
        main_page.click_element(locator)
        main_page.switch_tab_if_needed(opens_new_tab)
        ...
        assert element is not None and element.is_displayed(), (
            ...
            f"Либо не отображается на странице."
        )
